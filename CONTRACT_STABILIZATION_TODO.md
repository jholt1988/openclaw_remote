...
Last refreshed: 2026-04-30 21:49 Asia/Kuala_Lumpur
...
- [x] Review and implement test coverage improvements
  - Added direct `LeaseService` core workflow coverage for create/status/renewal-offer/tenant-response/tenant-notice/manager-notice/renewal-window behavior
  - Targeted Jest passed for lease + readiness suites: 8 suites, 65 passed
